        ...
        didOpen: (popup) => {
          ...
          if (btnPDF) {
            btnPDF.addEventListener("click", () => {
              ...
              const desde = document.getElementById("edcDesde")?.value;
              const hasta = document.getElementById("edcHasta")?.value;
